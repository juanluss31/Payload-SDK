...
#include "../raspberry/hal/hal_usb_bulk.h"
#include "../raspberry/hal/hal_uart.h"
#include "../raspberry/hal/hal_network.h"
...
T_DjiReturnCode Application::DjiUser_FillInUserInfo(T_DjiUserInfo *userInfo)
{
    ...
    if (!strcmp(USER_APP_NAME, "your_app_name") ||
        ...
        USER_LOG_ERROR(
            "Please fill in correct user information to 'samples/sample_c++/platform/linux/raspberry/application/dji_sdk_app_info.h' file.");
        return DJI_ERROR_SYSTEM_MODULE_CODE_INVALID_PARAMETER;
    }
